...
void saveMapPgmAndYaml(const nav_msgs::OccupancyGrid& map, const std::string& pgmFile, const std::string& yamlFile)
{
  ...
  fprintf(yaml, "image: %s\nresolution: %f\norigin: [%f, %f, %f]\nnegate: 0\noccupied_thresh: 0.65\nfree_thresh: 0.196\n\n",
          pgmFile.c_str(), map.info.resolution, map.info.origin.position.x, map.info.origin.position.y, 0.0);
