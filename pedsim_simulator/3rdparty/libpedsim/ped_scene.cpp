...
/// \note    Obstacles added to the Scene are not deleted if the Scene is destroyed. The reason for this is because they
/// could be member of another Scene theoretically.
...
/// \param   dist the distance around x/y that will be searched for agents (search field is a square in the current
/// implementation)
